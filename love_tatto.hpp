...
CONTRACT love_tattoo : public contract
{
  public:
    ...
    ACTION voting(name voter, uint64_t postid, uint64_t islike);
  ...
  private:
    ...
    typedef multi_index<"votes"_n, vote, indexed_by<"byvoter"_n, const_mem_fun<vote, uint64_t, &vote::by_voter>>, indexed_by<"bypostid"_n, const_mem_fun<vote, uint64_t, &vote::by_post_id>>> vote_index;
